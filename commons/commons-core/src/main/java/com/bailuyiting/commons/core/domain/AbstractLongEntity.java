 ...
 */
@MappedSuperclass
public abstract class AbstractLongEntity extends AbstractSuperEntity<Long> implements Serializable {
  ...
  public boolean equals(final Object obj) {
    ...
    if (!(obj instanceof AbstractLongEntity)) {
      return false;
    }
    final AbstractLongEntity that = (AbstractLongEntity) obj;
  ...
  protected void copy(final AbstractLongEntity source) {
    this.id = source.id;
  }
